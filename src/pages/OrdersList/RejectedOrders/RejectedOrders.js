...
function RejectedOrders() {
  ...
  return (
      ...
      <Sidebar/>
      <div >
    { rejectedOrders && rejectedOrders.length>0 ?<div className='container'><NavLink to="/discounts/add" className="btn btn-primary my-2">Add Order</NavLink>
